...
driver.find_element(By.XPATH, "/html/body/div/div/table/tbody/tr[63]/td[6]/a").click()
driver.find_element(By.ID, "first_team").send_keys("Argentina")
driver.find_element(By.ID, "second_team").send_keys("Portugal")
driver.find_element(By.ID, "first_team_goals").send_keys("2")
driver.find_element(By.ID, "second_team_goals").send_keys("3")
